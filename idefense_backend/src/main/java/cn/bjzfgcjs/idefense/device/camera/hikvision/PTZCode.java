...
public enum PTZCode {
         ...
         * 构造方法
         */
        private PTZCode(int key, String name) {
            this.key = key;
            this.name = name;
        }
         ...
         * @return
         */
        public static List<PTZCode> toList(){
            List<PTZCode> list = new ArrayList<PTZCode>();
            PTZCode[] s = PTZCode.values();
            for (PTZCode sit : s) {
                list.add(sit);
            }
            return list;
